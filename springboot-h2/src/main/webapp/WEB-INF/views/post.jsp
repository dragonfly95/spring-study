...
<body>
    ...
    <header class="intro-header" style="background-image: url('http://www.onnuri.org/wp-content/uploads/2017/01/2017_m_o_02.png')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        ...
                        <span class="meta">Posted by <a href="#">Origoni</a> on ${post}</span>
                    </div>
                </div>
            </div>
        </div>
